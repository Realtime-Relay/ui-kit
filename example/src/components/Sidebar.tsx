    ...
    >
      ...
      <nav style={{ padding: "12px 8px", flex: 1 }}>
        ...
        <NavItem
          ...
          active={activePage === "presence"}
          onClick={() => onNavigate("presence")}
          icon="●"
        />
        <NavItem
          label="Progress Bar"
          active={activePage === "progressbar"}
          onClick={() => onNavigate("progressbar")}
          icon="▬"
        />
        <NavItem
          label="Gauges"
          active={activePage === "gauges"}
          onClick={() => onNavigate("gauges")}
          icon="◔"
        />
        <NavItem
          label="Stat Cards"
          active={activePage === "statcards"}
          onClick={() => onNavigate("statcards")}
          icon="▣"
        />
        <NavItem
          label="State Timeline"
          active={activePage === "timelines"}
          onClick={() => onNavigate("timelines")}
          icon="▰"
        />
        <NavItem
          label="Time Series"
          active={activePage === "timeseries"}
        ...
        <NavItem
          ...
          icon="▦"
          badge={!isConfigured ? "Setup" : undefined}
        />
        <NavItem
          label="Settings"
