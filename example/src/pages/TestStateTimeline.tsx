...
function Card({ title, children, height = 120, style }: { title: string; children: React.ReactNode; height?: number; style?: React.CSSProperties }) {
  return (
    <div
    ...
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16, marginBottom: 32 }}>
        ...
        <Card title="Single Device">
          <StateTimeline data={singleDevice} stateMapper={threeStateMapper} metricKey="value" />
        </Card>

        <Card title="Three Devices" height={160}>
          <StateTimeline data={threeDevices} stateMapper={threeStateMapper} metricKey="value" />
        </Card>
        ...
        <Card title="Custom Row Height" height={200}>
          <StateTimeline data={threeDevices} stateMapper={threeStateMapper} metricKey="value" rowHeight={48} />
        </Card>

        <Card title="Two States" height={100}>
          <StateTimeline data={singleDevice} stateMapper={onlineOfflineMapper} metricKey="value" />
        </Card>

        <Card title="Five States" height={100}>
          <StateTimeline data={singleDevice} stateMapper={fiveStateMapper} metricKey="value" />
        </Card>

        <Card title="Long Device Names" height={160}>
          <StateTimeline data={longNameDevices} stateMapper={threeStateMapper} metricKey="value" />
        </Card>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16, marginBottom: 32 }}>
        ...
        <Card title="Multi Day Data" height={100}>
          <StateTimeline data={multiDayData} stateMapper={threeStateMapper} metricKey="value" />
        </Card>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16, marginBottom: 32 }}>
        ...
        <Card title="Empty Data" height={100}>
          <StateTimeline data={{}} stateMapper={threeStateMapper} metricKey="value" />
        </Card>

        <Card title="Empty No Loading" height={100}>
          <StateTimeline data={{}} stateMapper={threeStateMapper} metricKey="value" showLoading={false} />
        </Card>

        <Card title="Empty Device Arrays" height={160}>
          <StateTimeline data={emptyDeviceArrays} stateMapper={threeStateMapper} metricKey="value" />
        </Card>

        <Card title="Mixed Empty Populated" height={160}>
          <StateTimeline data={mixedEmptyPopulated} stateMapper={threeStateMapper} metricKey="value" />
        </Card>
      </div>
