...
describe("PresenceIndicator", () => {
  ...
  describe("sizing", () => {
    ...
    it("accepts custom size", () => {
      const { container } = render(
        <PresenceIndicator online={true} size={24} />,
      );
      const el = container.firstChild as HTMLElement;
    ...
    it("handles small sizes", () => {
      const { container } = render(
        <PresenceIndicator online={true} size={6} />,
      );
      const el = container.firstChild as HTMLElement;
    ...
    it("handles large sizes", () => {
      const { container } = render(
        <PresenceIndicator online={true} size={48} />,
      );
      const el = container.firstChild as HTMLElement;
  ...
  describe("colors", () => {
    ...
    it("falls back to CSS variable when no custom color provided (offline)", () => {
      const { container } = render(<PresenceIndicator online={false} />);
      const el = container.firstChild as HTMLElement;
      expect(el.style.backgroundColor).toContain(
        "var(--relay-presence-offline",
      );
    });
  });
  ...
  describe("edge cases", () => {
    it("handles size=0 without crashing", () => {
      const { container } = render(
        <PresenceIndicator online={true} size={0} />,
      );
      const el = container.firstChild as HTMLElement;
