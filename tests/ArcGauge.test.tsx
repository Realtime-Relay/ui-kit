...
describe("ArcGauge", () => {
  describe("rendering", () => {
    it("renders an SVG element", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} />,
      );
  ...
  describe("value display", () => {
    it("displays the formatted value", () => {
      const { container } = render(
        <ArcGauge data={{ value: 75.5, timestamp: null }} />,
      );
    ...
    it("displays unit text inline with value", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} unit="%" />,
      );
    ...
    it("displays label text", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} label="humidity" />,
      );
      const texts = container.querySelectorAll("text");
      const hasLabel = Array.from(texts).some(
        (t) => t.textContent === "humidity",
      );
  ...
  describe("min/max labels", () => {
    ...
    it("displays custom min and max", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} min={-50} max={150} />,
      );
      const texts = container.querySelectorAll("text");
      const textContents = Array.from(texts).map((t) => t.textContent);
  ...
  describe("alert zones", () => {
    ...
    it("renders zone arc paths", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} alertZones={zones} />,
      );
      const paths = container.querySelectorAll("path");
    ...
    it("value fill color matches active zone", () => {
      const { container } = render(
        <ArcGauge data={{ value: 80, timestamp: null }} alertZones={zones} />,
      );
      const paths = container.querySelectorAll("path");
  ...
  describe("accessibility", () => {
    ...
    it("has aria-valuenow", () => {
      const { container } = render(
        <ArcGauge data={{ value: 75, timestamp: null }} />,
      );
      const svg = container.querySelector("svg");
    ...
    it("has aria-valuemin and aria-valuemax", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} min={0} max={200} />,
      );
      const svg = container.querySelector("svg");
    ...
    it("has aria-label from label prop", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} label="RPM" />,
      );
      const svg = container.querySelector("svg");
  ...
  describe("edge cases", () => {
    it("throws when min === max", () => {
      expect(() =>
        render(
          <ArcGauge data={{ value: 50, timestamp: null }} min={50} max={50} />,
        ),
    ...
    it("throws when min > max", () => {
      expect(() =>
        render(
          <ArcGauge data={{ value: 50, timestamp: null }} min={100} max={0} />,
        ),
    ...
    it("renders with value=0", () => {
      const { container } = render(
        <ArcGauge data={{ value: 0, timestamp: null }} />,
      );
      expect(container.querySelector("svg")).toBeTruthy();
    });
    ...
    it("renders with very large values", () => {
      const { container } = render(
        <ArcGauge data={{ value: 999999, timestamp: null }} max={1000000} />,
      );
      expect(container.querySelector("svg")).toBeTruthy();
    });
    ...
    it("renders with empty alert zones array", () => {
      const { container } = render(
        <ArcGauge data={{ value: 50, timestamp: null }} alertZones={[]} />,
      );
      expect(container.querySelector("svg")).toBeTruthy();
    });
  });
